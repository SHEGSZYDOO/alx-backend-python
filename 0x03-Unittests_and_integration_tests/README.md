...
2 - Familiarize yourself with the utils.get_json function.
...
3 - Read about memoization and familiarize yourself with the utils.memoize decorator.
...
4 - Familiarize yourself with the client.GithubOrgClient class.
...
5 - memoize turns methods into properties. Read up on how to mock a property (see resource).
